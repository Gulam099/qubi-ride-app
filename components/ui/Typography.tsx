  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="1"
        className={cn(
          "web:scroll-m-20 text-4xl text-foreground font-noto-medium font-extrabold tracking-tight lg:text-5xl web:select-text",
          className
        )}
        ref={ref}
        {...props}
...
const P = forwardRef<TextRef, SlottableTextProps>(
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        className={cn("text-base text-foreground font-regular web:select-text", className)}
        ref={ref}
        {...props}
      />
    );
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        className={cn(
          "mt-6 native:mt-4 border-l-2 border-border pl-6 native:pl-3 text-base text-foreground italic web:select-text font-medium",
          className
        )}
        ref={ref}
        {...props}
