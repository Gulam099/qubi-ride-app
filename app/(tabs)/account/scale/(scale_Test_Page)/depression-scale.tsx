    ...
    <View className="p-4 h-full flex flex-col justify-between gap-4 bg-blue-50/10">
      <View className="flex-1 gap-4 items-center justify-center bg-white rounded-2xl px-4 py-8">
        ...
        <Text className="text-gray-600 text-center leading-6">
          {
          t("This simple test will help you assess and understand your level of depression. Your answers will assist us in determining your mental health level and guiding you towards a suitable session to support your mental health.")          }
        </Text>
      </View>
      ...
      <View className="bg-blue-50/50 p-4 rounded-md mt-6">
        <Text className="text-xs text-gray-800 text-center">
          {
           t("Reference: Prepared by doctors Robert L. Spitzer, Janet B.W. Williams, Kurt Kroenke, and colleagues, with an educational grant from Pfizer Inc.")
          }
        </Text>
      </View>
